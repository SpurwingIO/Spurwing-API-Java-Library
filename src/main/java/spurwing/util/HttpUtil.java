...
public class HttpUtil {
     ...
     * @throws IOException
     */
    static public String postJson(String url, String jsonStr, Map<String, String> headers) throws IOException {
        Map<String, String> new_headers = new HashMap<String, String>();
		new_headers.put("Content-Type", "application/json;charset=UTF-8");
		new_headers.putAll(headers); // add all parameter headers into new_headers
        return post(url, jsonStr, new_headers);
    }
